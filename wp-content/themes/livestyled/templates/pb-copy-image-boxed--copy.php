<div class="block theme--<?php echo $sectionCopyTheme; ?> flexbox justify-content-center align-items-center anim-500 anim-d-300 anim-ease-out" data-animate="slideIn<?php echo ucfirst($sectionAlignment); ?>">
    ...
    <div class="box-sub-container">
        ...
        <img class="section__header-icon lazyload anim-500 anim-d-700" data-animate="fadeInUp" data-src="<?php echo $sectionHeaderIcon['url']; ?>" alt="<?php echo $sectionHeader; ?>">
        <?php endif; ?>

        <?php if( $sectionHeader ) : ?>
        <h1 class="section__header section__header--copy-image anim-500 anim-d-800" data-animate="fadeInUp"><?php echo $sectionHeader; ?></h1>
        <?php endif; ?>

        <?php if( $sectionSubHeader ) : ?>
        <h2 class="section__sub-header section__sub-header--copy-image anim-500 anim-d-800" data-animate="fadeInUp"><?php echo $sectionSubHeader; ?></h2>
        <?php endif; ?>

        <div class="section__copy anim-500 anim-d-1000" data-animate="fadeInUp">
